...
FNAME = "/home/developer/python/chips_datasets/cornell_movie_dialogs_corpus/cornell movie-dialogs corpus/movie_lines.txt"
LINE_SEP = " +++$+++ "
DEBUG = True
...
def parse_line():
    ...
    for j in range(0, len(dialogs)):
        ...
        if last_ch_id == character_id:
            ...
            if DEBUG:
                print(
                    "Looks like: same film ({} == {}), line only diff on 1 ({} = {} + 1), and characters are different ({} != {}). Saving"
...
def get_text_films_data():
    print("get_text_films_data")
    parse_line()
